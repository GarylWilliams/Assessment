...
/**************************************************************************************
------------ ANSWER -------------------
inside the computer will return the const 4 outside it will return undefined 
**************************************************************************************/
...
(function() { 
  "use strict";
  var date = new Date(1983, 3, 21, 14, 39, 7);
  var birthday;
  function bdayMsg() {
...
(function testerTwo() {
  "use strict";
  var today = new Date();
  console.log("#6 stringDate", today.toDateStringstringDate)
